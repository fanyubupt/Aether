...
def get_config():
    ...
    parser.add_argument("--experiment_name", type=str, default="single",
    ...
    parser.add_argument("--num_env_steps", type=int, default=500,
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default='te', help="specify the name of environment")
    ...
    parser.add_argument("--clip_param", type=float, default=0.8,
    ...
    # TE task and additional model parameters
    parser.add_argument("--topo",type=str, default="Abilene")
    parser.add_argument("--use_single_topo", action='store_true', default=False)
    parser.add_argument("--use_next_sample", action='store_true', default=False)
    parser.add_argument("--use_normal_attn", action='store_true', default=False)
    parser.add_argument("--train_topos",type=str,nargs='+',default=['Abilene', 'Geant'])
    parser.add_argument("--test_topos",type=str,nargs='+',default=['B4', 'Kdl'])
    parser.add_argument("--obj", type=str,default='total_flow')
    parser.add_argument("--num_path", type=int, default=4)
    parser.add_argument("--decision_unit", type=int, default=1)
